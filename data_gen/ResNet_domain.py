...
class ResNet_before(nn.Module):
    ...
    def __init__(
        ...
        super(ResNet_before, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
class ResNet_after(nn.Module):
    ...
    def __init__(
        ...
        super(ResNet_after, self).__init__()
...
def resnet18_bef(**kwargs: Any) -> ResNet_before:
    return ResNet_before(BasicBlock, [2, 2, 2, 2], **kwargs)

def resnet18_aft(**kwargs: Any) -> ResNet_after:
    return ResNet_after(BasicBlock, [2, 2, 2, 2], **kwargs)
